# Generated by Django 5.1.4 on 2024-12-17 16:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_role_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='backend.userrole')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blog_post_type_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='backend.blogposttype')),
                ('group_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.customgroup')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('content', models.TextField()),
                ('date', models.DateField(auto_now_add=True)),
                ('blog_post_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='backend.blogpost')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('group_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='backend.customgroup')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(auto_now_add=True)),
                ('content', models.TextField()),
                ('comment_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='backend.comment')),
                ('group_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='backend.customgroup')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
