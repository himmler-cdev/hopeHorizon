# Generated by Django 4.2.16 on 2024-12-02 20:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blog_post_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.blogpost')),
        ...
        migrations.AddField(
            model_name='user',
            name='user_role',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.userrole'),
        ),
        migrations.AddField(
            model_name='user',
            name='user_tracker',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.usertracker'),
        ),
    ]
