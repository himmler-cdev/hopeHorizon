# Generated by Django 4.2.16 on 2025-01-29 22:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forum_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='backend.forum')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('forum_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='backend.forum')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='blogpost',
            name='blog_post_type_id',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='backend.blogposttype'),
        ),
        migrations.AddField(
            model_name='blogpost',
            name='forum_id',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.forum'),
        ),
        migrations.AddField(
            model_name='blogpost',
            name='user_id',
