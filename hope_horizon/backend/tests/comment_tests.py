...
class CommentTests(TestCase):
    ...
    def setUp(self):
        ...
        self.comment = Comment.objects.create(
            ...
            date=date.today(), #TODO: if autogenerated, remove this?
    ...
    def test_get_comments_list_bad_request(self):
        ...
        response = self.client.get("/api/comment?blog=0&page=0", follow=True)
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
    
    def test_get_comments_list_not_found(self):
        # Test retrieving comments for a non existant blog post
        response = self.client.get("/api/comment?blog=99999999999999&page=0", follow=True)
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
    ...
    def test_delete_comment_bad_request(self):
        ...
        # TODO:405 Method Not Allowed don't know what that means
        #response = self.client.delete("/api/comment/#####/")
        #self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)

        # TODO: Does not work cause always rounds to an integer
